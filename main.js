  ...
  <section class="hero">
    ...
    <div class="hero-content">
       ...
       <h2 class="hero-subtitle">
            Where Advertising Meets Discord Bots
       </h2>

<div class="container">
      <div class="d-flex justify-content-center">
       <div class="searchbar">
          <input autocomplete="off" class="search_input" type="search" name="query" id="searchquery" placeholder="Search for...">
...
<div class="featured text-center" id="bumped" >
  <br />
  <br />
  <h1>Bumped Bots</h1>
  <br />
