...
module.exports = `
<head>
  <title>User | {{userusername}}#{{userdiscriminator}} | Aero Bot List</title>
...
<li class="nav-item">	
  ...
  <section class="hero">
    ...
    <div class="hero-content">
       ...
       <a class="hero-title" id="avatar">
          <img src="{{useravatar}}" style="border-radius: 50%;">
       </a>
      
      <h1 class="hero-subtitle" id="username">
          {{userusername}}#{{userdiscriminator}}
      </h1>
...
<div class="featured text-center" id="userbots" >
  <br />
  <br />
  <h1>This User's Bots</h1>
  <br />
<div class="row justify-content-center mx-auto" id="userbots" style="width: 75%;">
{{bots}}
<br>
<br>
</div>
...
function resubmit(){
  $.ajax({
  type: "POST",
  url: "https://aerobotlist.com/resubmitbot",
  data: JSON.stringify({
    "botid": document.getElementById("resubmitdropdown").value
  }),
  headers: {
